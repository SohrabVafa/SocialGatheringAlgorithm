            ...
            for (int j=0; j<tamGrupo && (evals<maxEvals); j++) {
                if (j != best) {
                    ...
                    if (dist < cercania) {
                        ...
                        if (poblacion[posBest].peso < 20 && poblacion[posComparar].peso+poblacion[posBest].peso>=20) {
                            soliswets(poblacion[posBest].v, poblacion[posBest].fitness, 0.2, min(200, maxEvals-evals), -100, 100, gen);
                        ...
                        // cout<<"Uniendo!!! ->>> Peso: "<<poblacion[posBest].peso<<" Fitness: "<<poblacion[posBest].fitness<<endl;
                        uniones++;
                    }
                }
            }
